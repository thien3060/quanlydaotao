    ...
    class MessageBoxUtils
    {
        public static DialogResult Error(Exception ex)
        {
            return XtraMessageBox.Show(ex.Message,
                                       "Quản lý đạo tạo", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }

        public static DialogResult Error(string message)
        {
            return XtraMessageBox.Show("Lỗi: " + message, "Quản lý đạo tạo",
                                       MessageBoxButtons.OK, MessageBoxIcon.Error);
        }

        public static DialogResult Success(string message)
        {
            return XtraMessageBox.Show(message, "Quản lý đạo tạo",
